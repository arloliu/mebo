...
func TestBP128TimestampContract(t *testing.T) {
	values := []int64{1_700_000_000_000_000, 1_700_000_001_000_000, 1_700_000_002_000_000}
	data := bp128Encode(values, endian.GetBigEndianEngine())
	require.Equal(t, values, bp128Decode(data, len(values), endian.GetBigEndianEngine()))
}
